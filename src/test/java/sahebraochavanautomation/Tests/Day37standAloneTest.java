...
public class Day37standAloneTest {
...
public static void main(String[] args) {
	...
	Day38LandingPage landingPage = new Day38LandingPage(driver);
	driver.findElement(By.id("userEmail")).sendKeys("nandini.1@gmail.com");
	driver.findElement(By.id("userPassword")).sendKeys("Chavan@1234");
